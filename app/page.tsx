        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-stone-900 text-white p-8">
            ...
            <p className="text-stone-400 text-sm mb-6 leading-relaxed">
              Spry – zusammen über 30 Jahre Erfahrung auf Beratungs- und Unternehmensseite in nationalen und internationalen Markenprojekten. Persönlich, erfahren, effizient ohne unnötigen Overhead. Hinterlassen Sie Ihre E-Mail und wir melden uns direkt.
            </p>
